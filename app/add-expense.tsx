    ...
    <View style={[commonStyles.container, { paddingHorizontal: 16 }]}>
      ...
      <View style={[commonStyles.card, { marginTop: 12 }]}>
        ...
        <TextInput
          ...
          style={{ backgroundColor: colors.background, color: colors.text, padding: 12, borderRadius: 12, boxShadow: '0 2px 8px rgba(0,0,0,0.06)' as any }}
        />
        ...
        <View style={{ flexDirection: 'row', marginTop: 12 }}>
          <Text
            ...
            style={{
              ...
              marginRight: 8,
              borderRadius: 20,
              backgroundColor: !isIncome ? '#EF4444' : colors.background,
          ...
          <Text
            ...
            style={{
              ...
              paddingHorizontal: 12,
              borderRadius: 20,
              backgroundColor: isIncome ? '#10B981' : colors.background,
              color: isIncome ? '#fff' : colors.text,
              fontWeight: '800',
            }}
          >
